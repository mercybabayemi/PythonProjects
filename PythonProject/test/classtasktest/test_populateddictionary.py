...
from classtask import populatedictionary
...
class MyTestCase(TestCase):
    def test_that_function_exist(self):
        ...
        populatedictionary.get_populate_dictionary(list1, list2)

    def test_that_function_return_correct_value(self):
        list1 = ["cohort24", "cohort23", "cohort22", "cohort21", "cohort20"]
        list2 = ["4 months", "5 months", "6 months", "7 months", "8 months"]
        actual = populatedictionary.get_populate_dictionary(list1, list2)
